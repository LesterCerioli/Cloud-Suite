...
{
    public class CheckStateExistsByStateNameResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckStateExistsByStateNameResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckStateExistsByStateNameResponse(requestId, validationFailure);
