...
{
    public class CheckVendorExistsByCnpjResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckVendorExistsByCnpjResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckVendorExistsByCnpjResponse(requestId, validationFailure);
