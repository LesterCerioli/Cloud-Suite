...
namespace CloudSuite.Modules.Application.Handlers.Core.Vendores.Responses.Tests
{
    public class CheckVendorExistsByCreationDateResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckVendorExistsByCreationDateResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckVendorExistsByCreationDateResponse(requestId, validationFailure);
