...
namespace CloudSuite.Modules.Application.Handlers.Core.AppSettings.Responses.Tests
{
    public class CheckAppSettingExistsByModuleResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckAppSettingExistsByModuleResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckAppSettingExistsByModuleResponse(requestId, validationFailure);
