...
namespace CloudSuite.Modules.Application.Tests.Handlers.Core.AppSettings.Responses
{
    public class CreateAppSettingResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_SetsPropertiesCorrectly()
        {
            ...
            // Act
            var response = new CreateAppSettingResponse(requestId, validationResult);
        ...
        public void Constructor_WithValidationFailure_SetsPropertiesCorrectly()
        {
            ...
            // Act
            var response = new CreateAppSettingResponse(requestId, validationFailure);
