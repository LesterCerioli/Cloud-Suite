...
{
    public class CheckAppSettingExistsByValueResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckAppSettingExistsByValueResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckAppSettingExistsByValueResponse(requestId, validationFailure);
