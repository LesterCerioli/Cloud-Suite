...
{
    public class CheckMediaExistsByFileNameResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckMediaExistsByFileNameResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckMediaExistsByFileNameResponse(requestId, validationFailure);
