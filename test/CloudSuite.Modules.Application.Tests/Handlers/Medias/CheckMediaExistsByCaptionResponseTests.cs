...
{
    public class CheckMediaExistsByCaptionResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckMediaExistsByCaptionResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckMediaExistsByCaptionResponse(requestId, validationFailure);
