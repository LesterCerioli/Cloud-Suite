...
namespace CloudSuite.Modules.Application.Handlers.Core.Medias.Responses.Tests
{
    public class CheckMediaExistsByFileSizeResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckMediaExistsByFileSizeResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckMediaExistsByFileSizeResponse(requestId, validationFailure);
