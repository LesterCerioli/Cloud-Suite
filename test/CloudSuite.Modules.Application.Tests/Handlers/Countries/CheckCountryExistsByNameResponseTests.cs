...
namespace CloudSuite.Modules.Application.Handlers.Core.Countries.Responses.Tests
{
    public class CheckCountryExistsByNameResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckCountryExistsByNameResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckCountryExistsByNameResponse(requestId, validationFailure);
