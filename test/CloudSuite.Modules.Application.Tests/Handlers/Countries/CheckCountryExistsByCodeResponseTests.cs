...
{
    public class CheckCountryExistsByCodeResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckCountryExistsByCodeResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckCountryExistsByCodeResponse(requestId, validationFailure);
