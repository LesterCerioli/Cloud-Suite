...
namespace CloudSuite.Modules.Application.Tests.Handlers.Core.Companies.Responses
{
    public class CreateCompanyResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_SetsPropertiesCorrectly()
        {
            ...
            // Act
            var response = new CreateCompanyResponse(requestId, validationResult);
        ...
        public void Constructor_WithValidationFailure_SetsPropertiesCorrectly()
        {
            ...
            // Act
            var response = new CreateCompanyResponse(requestId, validationFailure);
