...
{
    public class CheckCompanyExistsByCnpjResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckCompanyExistsByCnpjResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckCompanyExistsByCnpjResponse(requestId, validationFailure);
