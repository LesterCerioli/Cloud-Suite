...
{
    public class CheckCompanyExistsByRegisterNameResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckCompanyExistsByRegisterNameResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckCompanyExistsByRegisterNameResponse(requestId, validationFailure);
