...
{
    public class CheckAddressExistsByAddressLineResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_SetsPropertiesCorrectly()
        {
            ...
            // Act
            var response = new CheckAddressExistsByAddressLineResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_SetsPropertiesCorrectly()
        {
            ...
            // Act
            var response = new CheckAddressExistsByAddressLineResponse(requestId, validationFailure);
