...
namespace CloudSuite.Modules.Application.Handlers.Core.Districts.Responses.Tests
{
    public class CheckDistrictExistsByNameResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckDistrictExistsByNameResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckDistrictExistsByNameResponse(requestId, validationFailure);
