...
namespace CloudSuite.Modules.Application.Handlers.Core.Users.Responses.Tests
{
    public class CheckUserExistsByEmailResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckUserExistsByEmailResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckUserExistsByEmailResponse(requestId, validationFailure);
