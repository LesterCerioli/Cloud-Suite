...
{
    public class CheckRoboEmailExistsBySubjectResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckRoboEmailExistsBySubjectResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckRoboEmailExistsBySubjectResponse(requestId, validationFailure);
