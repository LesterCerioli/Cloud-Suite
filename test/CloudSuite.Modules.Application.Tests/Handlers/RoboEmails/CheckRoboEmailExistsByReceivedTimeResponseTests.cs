...
{
    public class CheckRoboEmailExistsByReceivedTimeResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckRoboEmailExistsByReceivedTimeResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckRoboEmailExistsByReceivedTimeResponse(requestId, validationFailure);
