...
namespace CloudSuite.Modules.Application.Handlers.Core.RoboEmails.Responses.Tests
{
    public class CheckRoboEmailExistsByMessageRecipientResponseTests
    {
        [Fact]
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckRoboEmailExistsByMessageRecipientResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckRoboEmailExistsByMessageRecipientResponse(requestId, validationFailure);
