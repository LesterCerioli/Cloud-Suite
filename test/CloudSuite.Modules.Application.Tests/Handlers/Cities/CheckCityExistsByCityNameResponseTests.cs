...
namespace CloudSuite.Modules.Application.Handlers.Core.Cities.Responses.Tests
{
    public class CheckCityExistsByCityNameResponseTests
    {
        public CheckCityExistsByCityNameResponseTests()
        {
        }
        ...
        public void Constructor_WithValidationResult_AddsErrors()
        {
            ...
            // Act
            var response = new CheckCityExistsByCityNameResponse(requestId, exists, validationResult);
        ...
        public void Constructor_WithValidationFailure_AddsError()
        {
            ...
            // Act
            var response = new CheckCityExistsByCityNameResponse(requestId, validationFailure);
