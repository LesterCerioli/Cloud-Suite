...
namespace CloudSuite.Modules.Application.Services.Implementations.Core
{
    public class SettingService : ISettingService
    {
        ...
        public SettingService(
            ...
            SettingDefitionProvider settingDefinitionProvider,
            ...
            public async Task<Dictionary<string, string>> GetAllSettingsForUserAsync(long userId)
            {
                ...
                foreach (var item in defaultSettings.Value)
                {
        ...
        private void SetCustomSettingValueForUser(User user, string name, string value)
        {
        ...
        void ISettingService.SetCustomSettingValueForUser(User user, string name, string value)
        {
