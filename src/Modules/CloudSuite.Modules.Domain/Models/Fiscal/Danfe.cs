...
namespace CloudSuite.Modules.Domain.Models.Fiscal
{
    public class Danfe : EntityBase
    {
        ...
        /// </summary>
        //Data Hora Emissao
        public DateTimeOffset? DateTimeIssue { get; set; }
        ...
        /// </summary>
        //Data Saida Entrada
        public DateTime? DepartureDateCheckIn { get; set; }
        ...
        /// </summary>
        //Hora Saida Entrada
        public TimeSpan? TimeDepartureInput { get; set; }
