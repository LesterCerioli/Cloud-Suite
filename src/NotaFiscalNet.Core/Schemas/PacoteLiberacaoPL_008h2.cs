...
{
    public class PacoteLiberacaoPL_008h2 : IPacoteLiberacaoNFe
    {
        private const string BasePath = "Schemas\\PL_008h2\\{0}";
        private const string BasePathEventoCancelamento = "Schemas\\Evento_Canc_PL\\{0}";
        private const string BasePathEventoCartaCorrecao = "Schemas\\Evento_CCe_PL\\{0}";
